...
### 测试与质量
- **集成测试重构**：将集成测试重构为9个有序独立步骤方法，提升测试可读性与隔离性
- **测试目录规范**：调整单元测试类的目录结构，优化测试项目组织
...
## v3.7.2026.0402 (2026-04-02)

### 新功能
- **多协议服务解析器**：新增 RemotingServiceResolver，支持多协议服务发现与解析

### 优化改进
- 优化 WebSocket 消息收发的内存管理与异常处理，提升稳定性

### 测试与质量
- 新增 NewLife.Remoting 全面集成测试用例，扩展测试覆盖至 409 项
- 增强并发与压力测试场景健壮性
- 完善 csproj 元数据及描述信息
