...
- [Api服务端开发指南](#api服务端开发指南)
  - [目录](#目录)
  - [概述](#概述)
    - [适用场景](#适用场景)
  - [核心架构](#核心架构)
  - [快速开始](#快速开始)
    - [1. 安装 NuGet 包](#1-安装-nuget-包)
    - [2. 配置服务 (Program.cs)](#2-配置服务-programcs)
    - [3. 实现设备控制器](#3-实现设备控制器)
    - [4. 实现设备服务](#4-实现设备服务)
  - [核心组件详解](#核心组件详解)
    ...
    - [SessionManager 会话管理](#sessionmanager-会话管理)
      ...
      - [会话清理](#会话清理)
  - [数据模型](#数据模型)
    - [DeviceContext 设备上下文](#devicecontext-设备上下文)
    - [登录请求/响应](#登录请求响应)
    - [心跳请求/响应](#心跳请求响应)
    - [命令模型](#命令模型)
    - [事件模型](#事件模型)
  - [WebSocket 长连接](#websocket-长连接)
    ...
    - [消息格式](#消息格式)
      - [心跳消息](#心跳消息)
      - [命令下发](#命令下发)
    - [WsCommandSession](#wscommandsession)
  - [扩展开发](#扩展开发)
    - [自定义设备服务](#自定义设备服务)
    - [自定义控制器](#自定义控制器)
    - [自定义令牌服务](#自定义令牌服务)
  - [最佳实践](#最佳实践)
    ...
    - [4. 安全建议](#4-安全建议)
  - [常见问题](#常见问题)
    - [Q: 如何实现集群部署？](#q-如何实现集群部署)
    - [Q: 如何处理大量设备同时登录？](#q-如何处理大量设备同时登录)
    - [Q: 如何实现设备分组/多租户？](#q-如何实现设备分组多租户)
    - [Q: 心跳间隔如何配置？](#q-心跳间隔如何配置)
